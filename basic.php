...
//页面信息设置----------------------------------------------------------------------------------------------------------
	...
	$aListGroupUrl = array("url0", "url1", "url2", "url3", "url4", "url5", "url6", "url7", "url8", "url9");
    ...
    $sStylesheet = '<link href="http://127.0.0.1/lining/Kaze-no-Toorimichi/css/subject.css" type="text/css" rel="stylesheet" />'; // 该页可选样式表
